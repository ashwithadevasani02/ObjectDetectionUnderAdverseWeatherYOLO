...
router.post('/predict', (req, res) => {
  uploadSingle(req, res, async (err) => {
    // Handle Multer upload errors (like file filter or file size exceeded)
    if (err) {
    ...
    try {
      // Return 503 if the Python model process isn't ready
      ...
      // Delegate inference to the persistent Python service
      ...
      // Safely cleanup the uploaded file
      try {
